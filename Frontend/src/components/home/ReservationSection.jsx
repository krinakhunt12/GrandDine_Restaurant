const ReservationSection = ({ setShowReservation }) => {
  return (
    <section
      id="reservation"
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <button
          ...
          className="relative inline-block px-10 py-3 border border-secondary text-white font-semibold hover:bg-yellow-500 hover:text-black transition rounded-full shadow-lg"
        >
          RESERVATION
        </button>
      </div>
